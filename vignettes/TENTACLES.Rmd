...
```{r preProcess, fig.align='center', fig.width=12, fig.height=7, warning=FALSE}
# pre-Process data
pp <- preProcess(
...
```{r runClassifiers, fig.align='center', fig.width=12, fig.height=7, warning=FALSE}
...
gc <- getConsensus(rc, n.min = 3, plot = FALSE)
```
